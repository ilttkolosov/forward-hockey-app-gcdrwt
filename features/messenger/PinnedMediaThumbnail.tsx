...
export interface PinnedMediaThumbnailProps {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (currentMedia.type === "image")
        setResult({ key, source: { uri, headers } });
      else
        dispose = requestMessengerPinVideoThumbnail(uri, headers, (frame) => {
