...
// Keep rapid scroll updates coalesced, but do not leave the sender waiting
// several seconds for the blue read state after the recipient stops scrolling.
const READ_RECEIPT_DEBOUNCE_MS = 750;
